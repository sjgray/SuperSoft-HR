...
L_0519:        LDA #$0A			; 11 images to display one after other
...
IMAGEL
!BYTE $00,$5A,$B5       ; low byte for image table in ram
!BYTE $10,$6B,$C6
!BYTE $21,$7C,$D7
!BYTE $32,$8B,$00
!BYTE $00,$00,$00,$00
...
IMAGEH
!BYTE $06,$10,$1A,$25,$2F,$39,$44,$4E,$58,$63,$6D,$00 ; high bytes for image table in ram
